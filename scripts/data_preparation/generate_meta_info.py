...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset_path", help="C:\\Users\Administrator\Desktop\\rain\gt")
    parser.add_argument("--output_path", default='./basicsr/data/meta_info/training_meta_info1.txt',
